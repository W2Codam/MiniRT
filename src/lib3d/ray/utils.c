...
/*   Updated: 2022/04/12 15:02:12 by dvan-der         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "lib3d.h"

bool	ray_in_right_dir(t_Ray ray, t_Cylinder)
{
...
t_ray	rotate_ray(t_Ray ray, t_FVec3 center, t_FVec3 dir);
{
	t_angle	angle;
	t_FVec3	rotated_dir;
	...
	angle = get_angle_to(dir, ft_new_fvec3(0, 1, 0));
