...
/*   Updated: 2022/04/19 16:44:57 by dvan-der         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	t_Ray	hitpoint_to_center = ft_new_ray(hit_pos, cylinder.dir);
	float	dist_to_cy_pl;
	t_FVec3	hitpoint_cy_pl;

	hitpoint_to_center = ft_new_ray(hit_pos, cylinder.dir);
	dist_to_cy_pl = ft_hit_plane_2(&hitpoint_to_center, cylinder.dir, cylinder.center);
	hitpoint_cy_pl = ft_ray_at(&hitpoint_to_center, dist_to_cy_pl);
	return (ft_normalize_fvec3_2(ft_sub_fvec3(hitpoint_cy_pl, cylinder.center)));
}
